...
namespace Application.FeaturesNotification.NotificationHandlers
{
    ...
    public class ConfigurationActionsNotificationMessageHandler : INotificationHandler<NotificationMessage>
    {
        ...
        public ConfigurationActionsNotificationMessageHandler(IApplicationDbContext applicationDbContext, IMediator mediator, RoleManager<Role> roleManager, IOptionsSnapshot<AssetURLS> assetUrls, UserManager<User> userManager)
        {
